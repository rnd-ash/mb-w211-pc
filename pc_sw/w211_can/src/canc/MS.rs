...
impl MS_308 {
    ...
    /// Sets Speed ​​limitation for display active (0 with CR)

    pub fn set_DBAA(&mut self, value: bool){ self.0 = (self.0 & 0xfffffffffdffffff) | ((value as u64) & 0x1) << 25; }

    /// Gets Speed ​​limitation for display active (0 with CR)
